...
（大能量机关推导中，运用了公式，由于没有插件GitHub无法自动渲染mathJax”，所以这一部分建议打开“[大能量机关推导.pdf](大能量机关推导.pdf)”查阅，或打开“[大能量机关推导.png](save_pic/大能量机关推导.png)”查看，或者下载到本地使用软件进行渲染）
